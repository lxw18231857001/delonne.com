...
if($uid=='')
{
    ...
    if(!$cfg_ml->IsLogin())
    {
        ...
        // include_once(dirname(__FILE__)."/templets/arcticle_login.htm");
         echo "<script> window.location.href='http://localhost/dededln/a/hytc/zlxz/'</script>";
    ...
    else
    {
        ...
        $dpl = new DedeTemplate();
         // include_once(DEDETEMPLATE."/default/article_register.htm");
        // $tpl = dirname(__FILE__)."/templets/index.htm";
         // $tpl =dirname(__FILE__)."/templets/article_center.htm";

        // include_once(dirname(__FILE__)."/templets/arcticle_login.htm");
         echo "<script> window.location.href='http://localhost/dededln/a/hytc/zlxz/'</script>";
         
         // echo "<script>window.location.href='http://localhost/dededln/a/hytc/gstz'</script>";
        // $tpl ="../templets/default/list_center.htm";
