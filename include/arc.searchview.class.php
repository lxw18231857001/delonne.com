...
class SearchView
{
    ...
    function GetPageListDM($list_len)
    {
        ...
        if($this->PageNo != 1)
        {
            ...
            $indexpage="<td width='50'><a href='".$purl."PageNo=1'>首页</a></td>\r\n";
        }
        else
        {
            $indexpage="<td width='50'>首页</td>\r\n";
        }
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<td width='50'><a href='".$purl."PageNo=$nextpagenum'>下一页</a></td>\r\n";
            $endpage="<td width='50'><a href='".$purl."PageNo=$totalpage'>末页</a></td>\r\n";
        }
        else
        {
            $endpage="<td width='50'>末页</td>\r\n";
        }
        ...
        for($j; $j<=$total_list; $j++)
        {
            if($j == $this->PageNo)
            {
                $listdd.= "<td width='50'>$j</td>\r\n";
            }
            else
            {
                $listdd.="<td width='50'><a href='".$purl."PageNo=$j'>".$j."</a></td>\r\n";
            }
        }
