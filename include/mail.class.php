...
// Trying to smtp.163.com:465 
// Error: Remote host returned ""
// Error: Cannot connenct to relay host smtp.163.com Error: (0) 
    function smtp_sockopen_relay()
    {
        $this->log_write("Trying to1 ".$this->relay_host.":".$this->smtp_port."\n");
    ...
    function smtp_sockopen_mx($address)
    {
        ...
        {
            $this->log_write("Trying to2 ".$host.":".$this->smtp_port."\n");
